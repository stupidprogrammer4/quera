...
-- Section2
    SELECT c.id as customer_id, c.name as customer_name FROM customers as c LEFT JOIN orders ON c.id = orders.customer_id WHERE orders.id IS NULL ORDER BY customer_name;
-- Section3
